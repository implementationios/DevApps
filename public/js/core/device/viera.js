    ...
    $.extend(true, Device_Viera, Events, {
		...
		if(this.year == '2012'){
			Control.setKeys({
				...
				FF: 417,
				RW: 412,
				// PENDIENTE DE VERIFICAR EN HARDWARE REAL: TOOLS, PUP, PDOWN, CHLIST,
				// PRECH, TXTMIX, FAVCH, EXIT e INFO no tienen keyCode confirmado para
				// el mando remoto de Panasonic Viera (2012). Se dejan en -1 (nunca
				// coincide con un keyCode real, por lo que estas teclas simplemente
				// no hacen nada -- no hay riesgo de colisión, solo falta
				// funcionalidad). No hay una fuente confiable disponible para
				// confirmar estos códigos sin probar en un TV/mando real; si se
				// obtienen los valores correctos, reemplazar aquí.
				TOOLS: -1,
				PUP: -1,
				PDOWN: -1,
				CHLIST: -1,
			...
			Control.setKeys({
				...
				// PENDIENTE DE VERIFICAR EN HARDWARE REAL: TOOLS, PUP, PDOWN, CHLIST,
				// PRECH, TXTMIX, FAVCH, EXIT e INFO no tienen keyCode confirmado para
				// el mando remoto de Panasonic Viera (2013). Se dejan en -1 (nunca
				// coincide con un keyCode real, por lo que estas teclas simplemente
				// no hacen nada -- no hay riesgo de colisión, solo falta
				// funcionalidad). No hay una fuente confiable disponible para
				// confirmar estos códigos sin probar en un TV/mando real; si se
