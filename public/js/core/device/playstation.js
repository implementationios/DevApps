	...
	$.extend(true, Device_Playstation, Events, {
		...
		setKeys: function() {
			Control.setKeys({
				...
				PUP: 33,
				PDOWN: 34,
				// PENDIENTE DE VERIFICAR EN HARDWARE REAL: PRECH y TXTMIX reutilizan
				// los códigos genéricos de teclado de escritorio Delete/Del, no
				// confirmados contra el mando/control real de PlayStation. Además
				// TOOLS, CHLIST, FAVCH y EXIT no existen en este driver (a diferencia
				// de otros donde se dejan en -1 explícito, aquí simplemente no están
				// definidos -- el efecto es el mismo: Control.key.TOOLS es undefined
				// y nunca coincide con un keyCode real). No hay una fuente confiable
				// disponible para completar esto sin probar en una consola real.
				PRECH: 46, // Delete
				TXTMIX: 110, // ,Del
				AUDIO: 173,
