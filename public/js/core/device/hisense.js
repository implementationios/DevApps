	...
	$.extend(true, Device_Hisense, Events, {
		...
		init: function(callback, cbscope) {
			...
			Control.setKeys({
				...
				PUP: 427,
				PDOWN: 428,
				// PENDIENTE DE VERIFICAR EN HARDWARE REAL: TOOLS, CHLIST, PRECH,
				// TXTMIX, FAVCH, EXIT e INFO no tienen keyCode confirmado para el
				// mando remoto de Hisense. Se dejan en -1 (nunca coincide con un
