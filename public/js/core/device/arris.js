	...
	$.extend(true, Device_Arris, Events, {
		...
		init: function(callback, scope) {
			...
			Control.setKeys({
				...
				// confirmados contra el mando real de Arris. Además TOOLS, CHLIST,
				// FAVCH y EXIT no existen en este driver (a diferencia de otros donde
				// se dejan en -1 explícito, aquí simplemente no están definidos -- el
				// efecto es el mismo: Control.key.TOOLS es undefined y nunca coincide
				// con un keyCode real). No hay una fuente confiable disponible para
				// completar esto sin probar en un decodificador Arris real.
				PRECH: 46, // Delete
				TXTMIX: 110, // ,Del
				INFO: 917556,
				TV: 917554,
