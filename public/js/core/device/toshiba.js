	...
	$.extend(true, Device_Toshiba, Events, {
		...
		setKeys: function() {
			...
			Control.setKeys({
				...
				// el mando remoto de Toshiba. Se dejan en -1 (nunca coincide con un
				// keyCode real, por lo que estas teclas simplemente no hacen nada --
				// no hay riesgo de colisión, solo falta funcionalidad). No hay una
				// fuente confiable disponible para confirmar estos códigos sin probar
				// en un TV/mando real; si se obtienen los valores correctos, reemplazar aquí.
				TOOLS: -1,
				PUP: -1,
				PDOWN: -1,
				CHLIST: -1,
