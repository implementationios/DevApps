    ...
    $.extend(true, Device_Webos, Events, {
		...
		setKeys: function() {
		    Control.setKeys({
				...
				PDOWN: 34,	//		*
				INFO: 457,	//
				// PENDIENTE DE VERIFICAR EN HARDWARE REAL: CHLIST, PRECH, TXTMIX,
				// FAVCH, TOOLS y EXIT no tienen keyCode confirmado para el mando
				// remoto de LG webOS. Se dejan en -1 (nunca coincide con un keyCode
				// real, por lo que estas teclas simplemente no hacen nada -- no hay
				// riesgo de colisión, solo falta funcionalidad). No hay una fuente
				// confiable disponible para confirmar estos códigos sin probar en un
				// TV/mando real; si se obtienen los valores correctos, reemplazar aquí.
				// Nota: antes existían PRECH:46 y TXTMIX:110 (códigos de Delete/Del de
				// teclado de escritorio, ya de por sí un valor sin verificar) definidos
				// ANTES de estas mismas claves -- por reglas de JS, una clave duplicada
				// en un objeto literal es reemplazada por la última, así que esos dos
				// valores ya estaban muertos/anulados en silencio y el comportamiento
				// real en producción ya era -1. Se eliminó la duplicación.
				CHLIST: -1,	//
				PRECH: -1,	//
				TXTMIX: -1,	//
				FAVCH: -1,	//
